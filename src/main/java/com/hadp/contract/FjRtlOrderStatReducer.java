...
public class FjRtlOrderStatReducer extends Reducer<IntWritable, FjRtlOrderBean, FjRtlOrderBean, NullWritable>{
    ...
    protected void reduce(IntWritable key, Iterable<FjRtlOrderBean> values, Context context)
        ...
        context.write(fjRtlOrderBean, NullWritable.get());
    }
